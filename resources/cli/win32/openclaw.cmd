...
if /i "%1"=="update" (
    echo openclaw is managed by 狗蛋AI ^(bundled version^).
    echo.
    echo To update openclaw, update 狗蛋AI:
    echo   Open 狗蛋AI ^> Settings ^> Check for Updates
